# skriv ut spelpanelen 
# Ta input från användaren 
# Ändra spelpanelen med användarens input 
# Validera inputen så inget kan skrivas över 
# Kolla om någon har vunnit. 5.1 kolla per rad 5.2 kolla per kollumn 5.3 diagonalt 

## funktioner att skapa
# print_board() - skriver ut spelplanen
# get_input() -  tar input från användaren 
# validate_input() - validerar input från användaren (det ska vara både ett valid input och en tom ruta)
